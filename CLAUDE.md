...
Ledgerly — a local-first personal finance tracker. Users import bank CSV statements (multi-step upload → column mapping → normalize → review → confirm), categorize transactions via user-defined rules, track recurring subscriptions, and view spending dashboards. No third-party bank integration, budgets, or cloud sync.
